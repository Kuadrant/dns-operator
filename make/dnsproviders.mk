...
COREDNS_NAMESERVERS="$(shell $(KUBECTL) get service kuadrant-coredns -n kuadrant-coredns -o=jsonpath={.status.loadBalancer.ingress[0].ip}):53"
...
local-setup-coredns-credentials:
	...
	$(KUBECTL) -n ${TARGET_NAMESPACE} create secret generic dns-provider-core-dns --type=kuadrant.io/coredns --from-literal=NAMESERVERS=$(COREDNS_NAMESERVERS) --from-literal=ZONES="k.example.com"
