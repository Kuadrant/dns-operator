...
var rootCMD = &cobra.Command{
	...
	PersistentPreRun: func(cmd *cobra.Command, args []string) {
		logf.SetLogger(output.NewLogger(verbose, displayLogs))
		output.SetOutputFormatter(outputFormat, verbose)
	},
}
...
func init() {
	...
	rootCMD.PersistentFlags().BoolVarP(&displayLogs, "display-logs", "l", false, "redirect logs to stdOut; default to false (redirecting to stdErr)")
