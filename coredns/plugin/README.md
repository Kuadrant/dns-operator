...
For a complete overview of CoreDNS integration with DNS Operator, see the [CoreDNS Integration Guide](https://github.com/Kuadrant/kuadrant-operator/blob/main/doc/overviews/coredns-integration.md).
...
For comprehensive local development and testing instructions, see the [CoreDNS Local Development Guide](../../docs/coredns/README.md).
...
- Local environment issues: [Local Development Guide Troubleshooting](../../docs/coredns/README.md#troubleshooting)
- General CoreDNS integration issues: [Integration Guide Troubleshooting](https://github.com/Kuadrant/kuadrant-operator/blob/main/doc/overviews/coredns-integration.md#troubleshooting)

## See Also

- [CoreDNS Integration Guide](https://github.com/Kuadrant/kuadrant-operator/blob/main/doc/overviews/coredns-integration.md) - Complete overview and production deployment
- [CoreDNS Local Development Guide](../../docs/coredns/README.md) - Local testing with Kind clusters
