...
| provider                  | string        | PROVIDER                  | DNS Provider(s) to enable.                                                                                            | "aws,google,inmemory,azure,coredns" |
| enable-probes             | bool          | ENABLE_PROBES             | Enable DNSHealthProbes controller.                                                                                    | "true"                              |
| insecure-health-checks    | bool          | INSECURE_HEALTH_CHECKS    | Allow DNSHealthProbes to use insecure certificates                                                                    | "true"                              |
