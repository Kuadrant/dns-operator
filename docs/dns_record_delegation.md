...
The `kubectl-kuadrant_dns` plugin provides a command to help with the secret generation.
See `kubectl-kuadrant_dns add-cluster-secret --help` for more information.
