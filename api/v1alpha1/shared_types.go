...
const (
	...
	// ZoneDomainFilterKey is the key of the optional comma separated list of domains to filter by (All provider secrets)
	ZoneDomainFilterKey = "ZONE_DOMAIN_FILTER"
	// ZoneIDFilterKey is the key of the optional comma separated list of provider specific zone ids to filter by (All provider secrets)
	ZoneIDFilterKey = "ZONE_ID_FILTER"
)
