...
// DNSHealthCheckProbeReconciler reconciles a DNSHealthCheckProbe object
...
// the DNSHealthCheckProbe object against the actual cluster state, and then
...
func (r *DNSHealthCheckProbeReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&kuadrantiov1alpha1.DNSHealthCheckProbe{}).
		Complete(r)
}
