...
func TestApply(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			&SyncPolicy{},
			&plan.Changes{Create: baz, UpdateOld: fooV1, UpdateNew: fooV2, Delete: bar},
			&plan.Changes{Create: baz, UpdateOld: fooV1, UpdateNew: fooV2, Delete: bar},
		},
		{
			...
			&UpsertOnlyPolicy{},
			&plan.Changes{Create: baz, UpdateOld: fooV1, UpdateNew: fooV2, Delete: bar},
			&plan.Changes{Create: baz, UpdateOld: fooV1, UpdateNew: fooV2, Delete: empty},
		},
		{
			// CreateOnlyPolicy clears the list of updates and deletions.
			&CreateOnlyPolicy{},
			&plan.Changes{Create: baz, UpdateOld: fooV1, UpdateNew: fooV2, Delete: bar},
			&plan.Changes{Create: baz, UpdateOld: empty, UpdateNew: empty, Delete: empty},
		},
	} {
		// apply policy
